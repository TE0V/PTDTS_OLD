...
MOTOR_MIN_SPEED = 0.45  # 30% minimum to overcome static friction
MOTOR_MAX_SPEED = 0.70  # 60% maximum for safety
...
class VelocityTrackingController:
    ...
    def __init__(self, motor, encoder, speed_linearizer):
        ...
        # Control parameters
        self.deadzone_pixels = 5  # Pixel deadzone
        self.max_velocity = 1000  # counts/sec (DRASTICALLY REDUCED - motor has friction issues)
        self.max_acceleration = 400  # counts/sec² (VERY GENTLE rate limiting)
        self.velocity_deadband = 60  # counts/sec (REDUCED - was 150, preventing motor start!)
        
        # PID gains - TUNED for high-friction motor
        # Motor needs >30% PWM to overcome static friction
        # Need strong gains to generate enough control velocity
    ...
    def _compute_velocity_command(self):
        ...
        with self.lock:
            ...
            kp_position = 0.4  # Much gentler pixel→velocity conversion
